 ...
 * @version v1 24/04/24
 */
public class RaceV3 extends Horse 
{
    ...
    public RaceV3(int distance, int selectedNumberOfHorses)
    {
        raceLength = distance;
    ...
    public void raceGUI(){
        ...
        mainPanel.add(sliderPanel, BorderLayout.CENTER); // Add slider panel
    ...
    public static void main(String [] args){
        RaceV3 r1 = new RaceV3(20, selectedNumberOfHorses);
        for (int i = 0; i < selectedNumberOfHorses; i++) {
